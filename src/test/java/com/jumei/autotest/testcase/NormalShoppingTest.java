...
public class NormalShoppingTest {
	...
	private static Logger logger = Logger.getLogger(NormalShoppingTest.class);
	
	@BeforeTest
	public void start(){
		System.setProperty("webdriver.chrome.driver", "source/driver/chromedriver.exe");
	...
	public static void main(String[] args) {
		...
		testng.setTestClasses(new Class[] { NormalShoppingTest.class });
